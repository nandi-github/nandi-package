...
def nd_get_quote_table(ticker , dict_result = False):
    """
        ticker : a single ticker
...
if __name__ == "__main__":
    ...
    en_dt = '06/06/2019'
    stock ='MSFT'
    nflx_data = nd_get_data(stock, start_date=  st_dt, end_date = en_dt)
    print (nflx_data.head())

    print (nd_get_quote_table(stock ))
